            ...
            >
                ...
                >
                    <motion.img
                        ...
                        className="w-30 md:w-52 object-cover rounded-md shadow-sm"
                        initial={{ scale: 0.8 }}
                        animate={{ scale: 1 }}
                ...
                >
                    <p className="mb-4">
                        ¡Bienvenidos a Piñatas Brillantes! Somos una pareja emprendedora que decidió comenzar este emocionante viaje en el mundo de las piñatas este año. Con mucho amor y dedicación, nos enfocamos en crear piñatas únicas, brillantes y llenas de magia para todas las ocasiones especiales.
                    </p>
                    <p className="mb-4">
